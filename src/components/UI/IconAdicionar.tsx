...
export const IconAdicionar = (props: IconAdicionarProps) => {
  ...
  return (
    <View className="flex-row items-center justify-end">
      ...
      <Pressable
        className={`justify-center items-center w-14 h-14 mb-2 border-2 border-transparent ${
          colorButton ? colorButton : "bg-rose-800"
        } rounded-2xl active:bg-black shadow-md shadow-black`}
        onPress={onPress}>
